...
interface AboutHeroControlsProps {
    brandData: BrandState;
    onUpdate: (newData: Partial<BrandState>) => void;
    isMobile: boolean;
}

export const AboutHeroControls = React.memo<AboutHeroControlsProps>(({ brandData, onUpdate, isMobile }) => {
    ...
    const updateSection = (updates: any) => {
        onUpdate({ sections: { ...brandData.sections, about: { ...brandData.sections.about, hero: { ...brandData.sections.about.hero, ...updates } } } } as any);
    };
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
                ...
                <TypographyEditControl
                    ...
                    onUpdate={onUpdate}
                    variant="sidebar"
                    textValue={(data as any).introText}
                    onTextUpdate={(val) => updateSection({ introText: val })}
                />
                <TypographyEditControl
                    label="Headline"
